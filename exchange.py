...
# Lee de variable de entorno POSITION_MODE (Railway variable)
# Valores válidos: "HEDGE" o "ONEWAY"
# Por defecto ONEWAY si no se define
_POSITION_MODE = _os.environ.get("POSITION_MODE", "ONEWAY").upper().strip()
print(f"[EXCHANGE] Modo posición: {_POSITION_MODE} (Railway var POSITION_MODE)")
