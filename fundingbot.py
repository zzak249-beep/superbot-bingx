...
def transfer_futures_to_spot(amount: float) -> bool:
    ...
    Endpoint correcto BingX: /openApi/wallets/v1/capital/innerTransfer/apply
    walletType:       3 = Perpetual Futures
    targetWalletType: 1 = Spot / Fund wallet
    """
    try:
        params = {
            "coin":             "USDT",
            "amount":           str(round(amount, 2)),
            "walletType":       "3",   # 3 = Perpetual Futures
            "targetWalletType": "1",   # 1 = Spot / Fund wallet
        }
        result = bx_post_spot(
            "/openApi/wallets/v1/capital/innerTransfer/apply", params
        )
