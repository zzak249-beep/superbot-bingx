...
FIX (this version): get_tracked_positions() expone qué symbol/side
tiene un entry propio registrado — independiente de la lista de
posiciones de toda la cuenta que devuelve el exchange. main.py y
position_manager.py lo usan para que count_open() y _manage_positions()
solo cuenten/toquen posiciones que este bot abrió.
"""
import json
import logging
import os
